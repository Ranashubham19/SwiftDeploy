    ...
    if (flowStep === 'pairing') {
      return (
        <div className="py-8 flex flex-col items-center text-center">
          <div className="w-14 h-14 border-4 border-blue-500/20 border-t-blue-500 rounded-full animate-spin mb-6"></div>
          <p className="text-white text-2xl font-black tracking-tight">Pairing Telegram</p>
          <p className="text-zinc-500 text-sm mt-3">Connecting your bot. Hang tight...</p>
        </div>
      );
    }
