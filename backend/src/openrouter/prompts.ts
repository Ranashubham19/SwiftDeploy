...
export const buildSystemPrompt = (input: BuildSystemPromptInput): string => {
  ...
  return [
    ...
    "- Output style requirements: plain text only, no Markdown markers, no tables, and no decorative symbols.",
    "- Keep responses readable with clear line breaks between sections.",
